...
<div class="sheet">
  ...
  <header class="masthead">
    ...
    <dl class="control">
      ...
      <div><dt>Source digest</dt><dd>${esc(f.sourceDigest.slice(0, 12))}</dd></div>
    </dl>
  </header>
...
${gaps}
  ...
  <footer>
    Generated by <code>kf overview</code> from source digest <code>${esc(f.sourceDigest.slice(0, 12))}</code> &mdash; a hash over the specification and the Warrant manifests this page projects, not over the commit containing it, which could not exist before the page was written. No wall&#8209;clock timestamp appears above, deliberately: a generated artifact that differs on every build turns a drift check into noise. Counts are the most perishable claims here; re&#8209;derive rather than trust them. Where this sheet and the specification disagree, the specification governs; where the specification and the code disagree, the code is right and the specification has drifted.
  </footer>
