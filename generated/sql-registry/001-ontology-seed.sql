...
insert into registry.action_type (id, audited, transactional) values
  ...
  ('grant_access', true, true),
  ('revoke_access', true, true),
  ('replicate_artifact_version', true, true),
  ('verify_artifact_location', true, true),
  ('allocate_enterprise_identifier', true, true),
  ...
  ('create_warrant_draft', true, true),
  ('revise_warrant_draft', true, true),
  ('submit_warrant', true, true),
  ('authorize_warrant_contract', true, true),
  ('withdraw_warrant_proposal', true, true),
  ('propose_warrant_amendment', true, true),
  ('authorize_warrant_amendment', true, true),
  ('reject_warrant_amendment', true, true),
  ('record_warrant_preflight', true, true),
  ('authorize_warrant_dispatch', true, true),
  ('attach_warrant_runtime_receipt', true, true),
  ('register_warrant_submission', true, true),
  ('open_warrant_blocker', true, true),
  ('resolve_warrant_blocker', true, true),
  ('pause_warrant', true, true),
  ('resume_warrant', true, true),
  ('propose_warrant_deviation', true, true),
  ('approve_warrant_deviation', true, true),
  ('reject_warrant_deviation', true, true),
  ('record_warrant_discovered_gap', true, true),
  ('register_warrant_artifact', true, true),
  ('register_warrant_evidence', true, true),
  ('attach_warrant_gate_run', true, true),
  ('record_warrant_inference', true, true),
  ('record_warrant_judgment', true, true),
  ('request_warrant_resolution', true, true),
  ('resolve_warrant', true, true),
  ('dispute_warrant_resolution', true, true),
  ('resolve_warrant_dispute', true, true),
  ('annul_warrant_resolution', true, true),
  ('supersede_warrant', true, true),
  ('deprecate_warrant', true, true)
