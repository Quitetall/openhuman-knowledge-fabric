...
insert into registry.schema_release (version, ontology_digest, is_current) values
  ('1.2.0-draft.1', 'a6bd646125392d4c450b1641c36f1d3223511153af92069201db9992f73ae61f', true)
...
insert into registry.object_type (id, title, authority_domain, enterprise_namespace, first_class) values
  ...
  ('warrant', 'Warrant', 'project', 'WAR', true)
...
insert into registry.action_type (id, audited, transactional, requires_capability) values
  ('create_initiative', true, true, null),
  ('triage_initiative', true, true, null),
  ('authorize_project', true, true, 'act'),
  ('activate_project', true, true, null),
  ('create_work_package', true, true, null),
  ('start_work_package', true, true, null),
  ('accept_work_package', true, true, null),
  ('issue_work_order', true, true, 'act'),
  ('accept_work_order', true, true, null),
  ('amend_work_order', true, true, null),
  ('submit_work_execution', true, true, null),
  ('review_work_execution', true, true, null),
  ('issue_acceptance', true, true, 'act'),
  ('propose_decision', true, true, null),
  ('accept_decision', true, true, 'act'),
  ('reject_decision', true, true, 'act'),
  ('supersede_decision', true, true, 'act'),
  ('open_change', true, true, null),
  ('approve_change', true, true, 'act'),
  ('verify_change', true, true, null),
  ('make_change_effective', true, true, 'act'),
  ('submit_invoice', true, true, null),
  ('approve_invoice', true, true, 'act'),
  ('authorize_payment', true, true, 'act'),
  ('record_payment_settlement', true, true, null),
  ('reconcile_payment', true, true, null),
  ('complete_project_technical', true, true, null),
  ('close_project_administrative', true, true, null),
  ('attach_evidence', true, true, null),
  ('register_external_artifact', true, true, null),
  ('correct_record', true, true, null),
  ('promote_configuration_item', true, true, null),
  ('supersede_configuration_item', true, true, 'act'),
  ('retire_configuration_item', true, true, null),
  ('publish_interface_contract', true, true, 'act'),
  ('deprecate_interface_contract', true, true, 'act'),
  ('withdraw_interface_contract', true, true, null),
  ('record_physical_binding', true, true, null),
  ('remove_physical_binding', true, true, null),
  ('add_controlled_document', true, true, null),
  ('submit_document_for_review', true, true, null),
  ('approve_controlled_document', true, true, 'act'),
  ('make_document_effective', true, true, 'act'),
  ('supersede_controlled_document', true, true, 'act'),
  ('withdraw_controlled_document', true, true, null),
  ('add_authored_fragment', true, true, null),
  ('revise_authored_fragment', true, true, null),
  ...
  ('publish_document_view', true, true, 'act'),
  ('record_document_proposal', true, true, null),
  ('apply_document_proposal', true, true, null),
  ('release_person_entitlement_exclusion', true, true, null),
  ('deactivate_organization', true, true, 'act'),
  ('reactivate_organization', true, true, 'act'),
  ('retire_organization', true, true, 'act'),
  ('deactivate_person', true, true, 'act'),
  ('reactivate_person', true, true, 'act'),
  ('bootstrap_organization', true, true, null),
  ('grant_person_clearance', true, true, 'act'),
  ('grant_access', true, true, 'act'),
  ('revoke_access', true, true, 'act'),
  ('replicate_artifact_version', true, true, null),
  ('verify_artifact_location', true, true, null),
  ('allocate_enterprise_identifier', true, true, 'act'),
  ('request_secure_object_access', true, true, null),
  ('issue_secure_object_capability', true, true, 'act'),
  ('revoke_secure_object_capability', true, true, 'act'),
  ('consume_secure_object_capability', true, true, null),
  ('request_secure_object_erasure', true, true, null),
  ('record_secure_object_erasure', true, true, 'act'),
  ('register_secure_object_authority_key', true, true, 'act'),
  ('revoke_secure_object_authority_key', true, true, 'act'),
  ('register_ml_aggregate_reference', true, true, null),
  ('register_ml_run_lineage', true, true, null),
  ('register_ml_metric_definition', true, true, null),
  ('register_ml_metric_segment', true, true, null),
  ('authorize_ml_metric_stream', true, true, 'act'),
  ('append_ml_metric_event', true, true, null),
  ('authorize_ml_promotion', true, true, 'act'),
  ('raise_nonconformity', true, true, null),
  ('contain_nonconformity', true, true, null),
  ('investigate_nonconformity', true, true, null),
  ('disposition_nonconformity', true, true, null),
  ('close_nonconformity', true, true, null),
  ('open_capa', true, true, null),
  ('approve_capa_plan', true, true, 'act'),
  ('implement_capa', true, true, null),
  ('check_capa_effectiveness', true, true, null),
  ('close_capa', true, true, null),
  ('register_supplier', true, true, null),
  ('qualify_supplier', true, true, null),
  ('restrict_supplier', true, true, null),
  ('disqualify_supplier', true, true, 'act'),
  ('register_equipment', true, true, null),
  ('place_equipment_in_service', true, true, null),
  ('remove_equipment_from_service', true, true, null),
  ('quarantine_equipment', true, true, null),
  ('retire_equipment', true, true, null),
  ('receive_complaint', true, true, null),
  ('triage_complaint', true, true, null),
  ('investigate_complaint', true, true, null),
  ('close_complaint', true, true, null),
  ('propose_risk_control', true, true, null),
  ('implement_risk_control', true, true, null),
  ('verify_risk_control', true, true, null),
  ('retire_risk_control', true, true, null),
  ('define_test', true, true, null),
  ('approve_test_definition', true, true, 'act'),
  ('supersede_test_definition', true, true, 'act'),
  ('plan_test_execution', true, true, null),
  ('execute_test', true, true, null),
  ('record_test_result', true, true, null),
  ('invalidate_test_execution', true, true, 'act'),
  ('create_warrant_draft', true, true, null),
  ('revise_warrant_draft', true, true, null),
  ('submit_warrant', true, true, null),
  ('authorize_warrant_contract', true, true, 'act'),
  ('withdraw_warrant_proposal', true, true, null),
  ('propose_warrant_amendment', true, true, null),
  ('authorize_warrant_amendment', true, true, 'act'),
  ('reject_warrant_amendment', true, true, null),
  ('record_warrant_preflight', true, true, null),
  ('authorize_warrant_dispatch', true, true, 'act'),
  ('attach_warrant_runtime_receipt', true, true, null),
  ('register_warrant_submission', true, true, null),
  ('open_warrant_blocker', true, true, null),
  ('resolve_warrant_blocker', true, true, null),
  ('pause_warrant', true, true, null),
  ('resume_warrant', true, true, null),
  ('propose_warrant_deviation', true, true, null),
  ('approve_warrant_deviation', true, true, 'act'),
  ('reject_warrant_deviation', true, true, null),
  ('record_warrant_discovered_gap', true, true, null),
  ('register_warrant_artifact', true, true, null),
  ('register_warrant_evidence', true, true, null),
  ('attach_warrant_gate_run', true, true, null),
  ('record_warrant_inference', true, true, null),
  ('record_warrant_judgment', true, true, null),
  ('request_warrant_resolution', true, true, null),
  ('resolve_warrant', true, true, 'act'),
  ('dispute_warrant_resolution', true, true, null),
  ('resolve_warrant_dispute', true, true, 'act'),
  ('annul_warrant_resolution', true, true, 'act'),
  ('supersede_warrant', true, true, 'act'),
  ('deprecate_warrant', true, true, 'act')
...
insert into registry.object_state (object_type, state, is_terminal) values
  ...
  ('warrant', 'draft', false),
  ('warrant', 'proposed', false),
  ('warrant', 'authorized', false),
  ('warrant', 'ready', false),
  ('warrant', 'executing', false),
  ('warrant', 'verifying', false),
  ('warrant', 'resolved', true)
...
insert into registry.state_transition (object_type, from_state, to_state, action_id) values
  ...
  ('warrant', 'draft', 'proposed', 'submit_warrant'),
  ('warrant', 'proposed', 'draft', 'withdraw_warrant_proposal'),
  ('warrant', 'proposed', 'authorized', 'authorize_warrant_contract'),
  ('warrant', 'authorized', 'ready', 'record_warrant_preflight'),
  ('warrant', 'ready', 'executing', 'authorize_warrant_dispatch'),
  ('warrant', 'executing', 'verifying', 'register_warrant_submission'),
  ('warrant', 'verifying', 'resolved', 'resolve_warrant'),
  ('warrant', 'ready', 'authorized', 'authorize_warrant_amendment'),
  ('warrant', 'executing', 'authorized', 'authorize_warrant_amendment'),
  ('warrant', 'verifying', 'authorized', 'authorize_warrant_amendment'),
  ('organization', 'active', 'inactive', 'deactivate_organization'),
  ('organization', 'inactive', 'active', 'reactivate_organization'),
  ('organization', 'active', 'retired', 'retire_organization'),
  ('organization', 'inactive', 'retired', 'retire_organization'),
  ('person', 'active', 'inactive', 'deactivate_person'),
  ('person', 'inactive', 'active', 'reactivate_person'),
  ('person', 'active', 'inactive', 'retire_organization')
