...
// source_digest: a6bd646125392d4c450b1641c36f1d3223511153af92069201db9992f73ae61f

/* eslint-disable */

export const SCHEMA_VERSION = '1.2.0-draft.1' as const;
export const ONTOLOGY_SOURCE_DIGEST = 'a6bd646125392d4c450b1641c36f1d3223511153af92069201db9992f73ae61f' as const;
...
/** Warrant — authority: project */
export type WarrantState = 'draft' | 'proposed' | 'authorized' | 'ready' | 'executing' | 'verifying' | 'resolved';
export interface WarrantAttributes {
  readonly warrant_uuid: string;
  readonly repository: string;
  readonly local_alias?: string;
  readonly profile: 'delivery' | 'research' | 'operations' | 'governance';
  readonly assurance_level: 'basic' | 'controlled' | 'high_assurance';
  readonly execution_condition: 'clear' | 'blocked' | 'paused';
  readonly outcome: 'none' | 'satisfied' | 'not_satisfied' | 'falsified' | 'rejected' | 'withdrawn' | 'cancelled' | 'inconclusive';
  readonly currency: 'current' | 'superseded' | 'deprecated';
  readonly standing: 'valid' | 'disputed' | 'annulled';
  readonly current_revision_no?: number;
  readonly authorized_revision_no?: number;
}
...
export const STATE_MACHINES = {
  ...
  organization: {
    ...
    terminal: ['retired'],
    transitions: [
      { from: 'active', to: 'inactive', action: 'deactivate_organization' },
      { from: 'inactive', to: 'active', action: 'reactivate_organization' },
      { from: 'active', to: 'retired', action: 'retire_organization' },
      { from: 'inactive', to: 'retired', action: 'retire_organization' },
    ],
  },
  person: {
    initial: 'active',
    terminal: [],
    transitions: [
      { from: 'active', to: 'inactive', action: 'deactivate_person' },
      { from: 'inactive', to: 'active', action: 'reactivate_person' },
      { from: 'active', to: 'inactive', action: 'retire_organization' },
    ],
  },
} as const;
