...
export const PRESERVATION_IMPORT_TARGETS = {
  ...
  'warrant-preflights': 'work.warrant_preflight',
  'warrant-dispatches': 'work.warrant_dispatch',
  'warrant-runtime-receipts': 'work.warrant_runtime_receipt',
  'warrant-submissions': 'work.warrant_submission',
  'warrant-blockers': 'work.warrant_blocker',
  'warrant-deviations': 'work.warrant_deviation',
  'warrant-discovered-gaps': 'work.warrant_discovered_gap',
  'warrant-artifacts': 'work.warrant_artifact',
  'warrant-evidence': 'work.warrant_evidence',
  'warrant-gate-runs': 'work.warrant_gate_run',
  'warrant-inferences': 'work.warrant_inference',
  'warrant-judgments': 'work.warrant_judgment',
  'warrant-resolution-requests': 'work.warrant_resolution_request',
