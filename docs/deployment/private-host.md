...
**The floor, and why full rollback is not claimed.** Fifteen migrations are one-way security
...
migration (currently `20260826000800_role_authority_resolver`). The earlier contract —
