...
**The floor, and why full rollback is not claimed.** Twelve migrations are one-way security
...
migration (currently `20260826000500_master_record_content_payload`). The earlier contract —
